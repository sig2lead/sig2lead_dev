...
#####################################################################                   
                  ...
                  br(),
                   ...
                   conditionalPanel(condition="input.Advanced_button ==  1 && input.Signature == 'Define Target Gene'",
                        ...
                        selectInput("ILINCS", "iLINCS Version", list("Current", "Legacy"), selected="Legacy"),
                        ...
                        conditionalPanel(condition="input.ConOrDiscon == 'Inhibit'",
                          ...
                          numericInput("Concordance", "Concordance Threshold", value=0.1, min=0.1, max=0.5, step=0.1)),
                  ...
                  conditionalPanel(condition="input.Advanced_button ==  1 && input.Signature == 'Find Analogs in LINCS'",
                    numericInput("topN", "Number of Analogs", value=1, min=1,max=5,step=1), 
                    selectInput("Algorithm","Chemical Similarity Search", list("minSim", "fpSim"), selected = "minSim"),
...
tabPanel("Help",
         mainPanel(
           includeHTML("./www/Sig2Lead_v1_user_manual_for_help.htm")
         )
)

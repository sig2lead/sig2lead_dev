...
#####################################################################                   
                     #br(),
                            selectInput("Signature", NULL, list("Define Target Gene", "Define Set of Target Genes", "Upload a Signature", "Find Analogs in LINCS"), selected = "Input a Gene"),
                     br(),
                     
                     conditionalPanel(
                       condition = "input.Signature == 'Define Target Gene'",
                            textInput("gene_knockdown", "Define a Target Gene", value="bcl2a1")
                     ),
                     conditionalPanel(
                      condition = "input.Signature == 'Define Set of Target Genes'",
                            textInput("gene_knockdown_1", "Define Target Gene 1", value="PIK3CA"),
                            selectInput("ConOrDiscon_1","Activation or Inhibition", list("Inhibit", "Activate"), selected = ),
                            conditionalPanel(condition="input.ConOrDiscon_1 == 'Inhibit'",
                                       #selectInput("Algorithm","Chemical Similarity Search", list("minSim","fpSim", "minLSH"), selected = "minSim"),
                                       numericInput("threshold_1", "Concordance Threshold", value=0.2, min=0.2, max=0.5, step=0.1)),
                            conditionalPanel(condition="input.ConOrDiscon_1 == 'Activate'",
                                       #selectInput("Algorithm","Chemical Similarity Search", list("minSim", "fpSim", "minLSH"), selected = "minSim"),
                                       numericInput("threshold_1", "Discordance Threshold", value=-0.2, min=-0.5, max=-0.2, step=-0.1)),
                      
                            br(),br(),
                            textInput("gene_knockdown_2", "Define Target Gene 2", value="AKT1"),
                            selectInput("ConOrDiscon_2","Activation or Inhibition", list("Inhibit", "Activate"), selected = ""), 
                            conditionalPanel(condition="input.ConOrDiscon_2 == 'Inhibit'",
                                             #selectInput("Algorithm","Chemical Similarity Search", list("minSim","fpSim", "minLSH"), selected = "minSim"),
                                             numericInput("threshold_2", "Concordance Threshold", value=0.2, min=0.2, max=0.5, step=0.1)),
                            conditionalPanel(condition="input.ConOrDiscon_2 == 'Activate'",
                                             #selectInput("Algorithm","Chemical Similarity Search", list("minSim", "fpSim", "minLSH"), selected = "minSim"),
                                             numericInput("threshold_2", "Discordance Threshold", value=-0.2, min=-0.5, max=-0.2, step=-0.1)),
                            
                            br(), br(),
                            textInput("gene_knockdown_3", "Define Target Gene 3", value="MTOR"),
                            selectInput("ConOrDiscon_3","Activation or Inhibition", list("Inhibit", "Activate"), selected = ""),
                            conditionalPanel(condition="input.ConOrDiscon_3 == 'Inhibit'",
                                             #selectInput("Algorithm","Chemical Similarity Search", list("minSim","fpSim", "minLSH"), selected = "minSim"),
                                             numericInput("threshold_3", "Concordance Threshold", value=0.2, min=0.2, max=0.5, step=0.1)),
                            conditionalPanel(condition="input.ConOrDiscon_3 == 'Activate'",
                                             #selectInput("Algorithm","Chemical Similarity Search", list("minSim", "fpSim", "minLSH"), selected = "minSim"),
                                             numericInput("threshold_3", "Discordance Threshold", value=-0.2, min=-0.5, max=-0.2, step=-0.1)),
                            br(),br(),
                            selectInput("gene_kd_union","Intersection or Union", list("Intersection", "Union"), selected = "Intersection")
                    ),
                     conditionalPanel(
